...
wanted_cols = c("score", "ghost_time", "ghost_sims_per_sec", "ghost_avg_decision_sims", "channel_speed")

root.data <- read.delim("results/20130530-2045-root-exchange-channel-speed.txt", row.names=NULL)
...
simpas.data <- read.delim("results/20130531-2251-simulation-passing-channel-speed.txt", row.names=NULL)
