...
root.data <- read.delim("results/20130505-2134-root-exchanging.txt", row.names=NULL)
...
simpas.data <- read.delim("results/20130505-2134-root-exchanging.txt", row.names=NULL)
simpas.data2 <- root.data[c("score", "ghost_time", "ghost_sims_per_sec","synchronization_ratio")]
