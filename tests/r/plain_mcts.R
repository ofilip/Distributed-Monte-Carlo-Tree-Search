...
plot_data <- function(my_data) {
	...
	scores_matrix <- scores_matrix[,3:5]
...
data <- read.delim("results/plain_mcts_test_20130322-tmp2.txt", row.names=NULL)
