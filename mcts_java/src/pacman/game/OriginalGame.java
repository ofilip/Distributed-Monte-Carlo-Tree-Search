 ...
 */
public final class OriginalGame implements Game
{
	 ...
	 */
	public OriginalGame(long seed,int initialMaze)
	{
		this.seed=seed;
		rnd=new Random(seed);
	 ...
	 * @return the game
	 */
	public OriginalGame copy()
	{
		OriginalGame copy=new OriginalGame();
