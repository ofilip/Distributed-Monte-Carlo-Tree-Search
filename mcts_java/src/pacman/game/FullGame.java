 ...
 */
public final class FullGame implements Game
{
	 ...
	 */
	public FullGame(long seed,int initialMaze)
	{
		this.seed=seed;
		rnd=new Random(seed);
	 ...
	 */
    @Override
	public FullGame copy()
	{
		FullGame copy=new FullGame();
