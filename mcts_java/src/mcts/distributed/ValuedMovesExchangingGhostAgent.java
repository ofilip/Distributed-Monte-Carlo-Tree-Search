...
public class ValuedMovesExchangingGhostAgent extends FullMCTSGhostAgent {   
    ...
    public ValuedMovesExchangingGhostAgent(final GHOST ghost, int simulation_depth, double ucb_coef, int moves_message_interval, boolean verbose) {
    ...
    public ValuedMovesExchangingGhostAgent(GHOST ghost, int simulation_depth, double ucb_coef, int moves_message_interval) {
