...
counts $n_i, i \in Children(r)$. After the root merging, all agents have identical
set of joint-action -- visit-count pairs. Joint-action with highest summed visit count is
...
difficulty when any oponent is considered because set $Children(r)$ may not be a set of actions of
our team. We could simply wait for opponents turn and exchange our messages during the period
...
root for turn-based games with multiple teams. \todo{Popsat Next-action Tree Cut}
