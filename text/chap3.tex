...
\begin{algorithm}
\DontPrintSemicolon
\caption{$DistributedFullTreeAgent(tree)$}
...
\emph{distributed full-joint-tree agent} and the basic algorithm is depicted by Algorithm
\ref{alg_dmcts_common}.
